...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.14/24 | 10.255.105.193 |
...
| --------- | --------------- | ------------ | --------- |
| AVD_LEAF2 | Vlan4094 | 10.255.252.4 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_AVD-LEAF2A_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_AVD-LEAF2A_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_AVD-SPINE1_Ethernet5 | routed | - | 172.31.255.13/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_AVD-SPINE2_Ethernet5 | routed | - | 172.31.255.15/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_AVD-LEAF2A_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_AVD-LEAF2A_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_AVD-LEAF2A_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_AVD-LEAF2A_Po1
   no shutdown
   switchport
...
| Loopback100 | Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | Tenant_A_OP_Zone | 10.254.1.6/32 |
...
| Tenant_A_OP_Zone | 192.168.255.6:10 | 10:10 | - | - | learned | 12,110-112 |
...
router bgp 65102
   ...
   neighbor 10.255.251.4 description AVD-LEAF2A
   neighbor 172.31.255.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.12 description AVD-SPINE1_Ethernet5
   neighbor 172.31.255.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.14 description AVD-SPINE2_Ethernet5
...
| -------------- | --------------------- |
| Tenant_A_OP_Zone | 10.254.1.6 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A_OP_Zone address 10.254.1.6
```
