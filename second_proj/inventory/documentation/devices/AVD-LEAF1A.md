...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.11/24 | 10.255.105.193 |
...
username arista privilege 15 role network-admin secret sha512 $6$65WelVlMdQ5fTGDP$G5HfqPlZwNl2FePG38sSMh5QfY/OWiVDeqYqkU1vBnPU0wswN0LXf6gRbsQCd4eEH.tvzRsZj3B2SuQ3kQQe01
...
| -------------- | --------------- | ------------------------- | -------------- | -------------- | ---------- | -------- | ------ |
| gzip | 192.168.0.5:9910 | UNSET | ale,flexCounter,hardware,kni,pulse,strata | /Sysdb/cell/1/agent,/Sysdb/cell/2/agent | MGMT | MGMT | False |
...
| --------- | --------------- | ------------ | --------- |
| AVD_LEAF1 | Vlan4094 | 10.255.252.1 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_AVD-LEAF1B_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_AVD-LEAF1B_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet11 |  server01_Ethernet1 | access | 110 | - | - | - |
| Ethernet12 |  server02_Ethernet2 | access | 110 | - | - | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_AVD-SPINE1_Ethernet2 | routed | - | 172.31.255.1/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_AVD-SPINE2_Ethernet2 | routed | - | 172.31.255.3/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_AVD-LEAF1B_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_AVD-LEAF1B_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_AVD-LEAF1B_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_AVD-LEAF1B_Po1
   no shutdown
   switchport
...
| Loopback100 | Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | Tenant_A_OP_Zone | 10.254.1.3/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan12 |  Tenant_A_OP_Zone_Test  |  Tenant_A_OP_Zone  |  -  |  false  |
...
| --- | ------------------ | ----------------------- | ------------------- | ----------------------------- | ----------------- | ----------------------------- | -------------- |
| MGMT  | 0.0.0.0/0 |  10.255.105.193  |  -  |  1  |  -  |  -  |  - |

### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.255.105.193
```
...
| Tenant_A_OP_Zone | 192.168.255.3:10 | 10:10 | - | - | learned | 12,110-112 |
...
router bgp 65101
   ...
   neighbor 10.255.251.1 description AVD-LEAF1B
   neighbor 172.31.255.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.0 description AVD-SPINE1_Ethernet2
   neighbor 172.31.255.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.2 description AVD-SPINE2_Ethernet2
...
| -------------- | --------------------- |
| Tenant_A_OP_Zone | 10.254.1.3 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A_OP_Zone address 10.254.1.3
```
