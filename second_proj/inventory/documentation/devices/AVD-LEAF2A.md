...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.13/24 | 10.255.105.193 |
...
| --------- | --------------- | ------------ | --------- |
| AVD_LEAF2 | Vlan4094 | 10.255.252.5 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_AVD-LEAF2B_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_AVD-LEAF2B_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_AVD-SPINE1_Ethernet4 | routed | - | 172.31.255.9/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_AVD-SPINE2_Ethernet4 | routed | - | 172.31.255.11/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_AVD-LEAF2B_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_AVD-LEAF2B_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_AVD-LEAF2B_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_AVD-LEAF2B_Po1
   no shutdown
   switchport
...
| Loopback100 | Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | Tenant_A_OP_Zone | 10.254.1.5/32 |
...
| Tenant_A_OP_Zone | 192.168.255.5:10 | 10:10 | - | - | learned | 12,110-112 |
...
router bgp 65102
   ...
   neighbor 10.255.251.5 description AVD-LEAF2B
   neighbor 172.31.255.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.8 description AVD-SPINE1_Ethernet4
   neighbor 172.31.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.10 description AVD-SPINE2_Ethernet4
...
| -------------- | --------------------- |
| Tenant_A_OP_Zone | 10.254.1.5 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A_OP_Zone address 10.254.1.5
```
