...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.12/24 | 10.255.105.193 |
...
| --------- | --------------- | ------------ | --------- |
| AVD_LEAF1 | Vlan4094 | 10.255.252.0 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_AVD-LEAF1A_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_AVD-LEAF1A_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet11 |  server01_Ethernet2 | access | 110 | - | - | - |
| Ethernet12 |  server02_Ethernet1 | access | 110 | - | - | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_AVD-SPINE1_Ethernet3 | routed | - | 172.31.255.5/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_AVD-SPINE2_Ethernet3 | routed | - | 172.31.255.7/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_AVD-LEAF1A_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_AVD-LEAF1A_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_AVD-LEAF1A_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_AVD-LEAF1A_Po1
   no shutdown
   switchport
...
| Loopback100 | Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | Tenant_A_OP_Zone | 10.254.1.4/32 |
...
| Tenant_A_OP_Zone | 192.168.255.4:10 | 10:10 | - | - | learned | 12,110-112 |
...
router bgp 65101
   ...
   neighbor 10.255.251.0 description AVD-LEAF1A
   neighbor 172.31.255.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.4 description AVD-SPINE1_Ethernet3
   neighbor 172.31.255.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.6 description AVD-SPINE2_Ethernet3
...
| -------------- | --------------------- |
| Tenant_A_OP_Zone | 10.254.1.4 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A_OP_Zone address 10.254.1.4
```
